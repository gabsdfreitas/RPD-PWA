...
Um app de diário para TCC (Terapia Cognitivo-Comportamental).

Criei esse projeto porque queria uma forma digital de fazer o **RPD (Registro de Pensamentos Disfuncionais)** que não fosse uma planilha chata ou um app cheio de assinaturas. A ideia é ter um ambiente calmo, com visual de "vidro" e nuvens, para registrar o que você está sentindo.
...
A simple, privacy-focused CBT (Cognitive Behavioral Therapy).

I built this because I needed a digital place to do my **Dysfunctional Thought Records (RPD)** without dealing with boring spreadsheets or subscription-based apps. It’s designed to be a calming space with glass textures and dynamic weather backgrounds to help you process your thoughts.
